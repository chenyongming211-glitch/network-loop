...
foreach ($Required in @(
    ...
    'relationship detection frame bound is invalid',
    ...
    'detection status summary generation mismatch',
    "@('none', 'ingress', 'egress', 'bidirectional')",
    "@('warming_up', 'ready', 'unavailable')",
