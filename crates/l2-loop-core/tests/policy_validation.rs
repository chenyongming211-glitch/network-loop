...
use l2_loop_core::{PolicyRequest, TrafficClass};
...
fn policy(
    ...
    class: TrafficClass,
    ttl_seconds: u64,
) -> Result<PolicyRequest, l2_loop_core::DomainError> {
    PolicyRequest::new(
        "bond0",
        None,
        class,
...
fn policy_with_vlan(vlan: u16) -> Result<PolicyRequest, l2_loop_core::DomainError> {
    PolicyRequest::new(
        "bond0",
        Some(vlan),
        TrafficClass::L2Broadcast,
