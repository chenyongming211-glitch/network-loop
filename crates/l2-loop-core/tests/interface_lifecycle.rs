use l2_loop_core::{
    ...
    ObservationCounters, ObservationHealth, SamplingStatus, TrafficClass, VlanVisibility,
...
fn status_supports_zero_or_one_bounded_session_summary() {
    ...
    let status = InterfaceStatus {
        ...
        detection: l2_loop_core::DetectionSummary::from(&l2_loop_core::DetectionReport::warming(
            l2_loop_core::RateIdentity::new(7, 7).unwrap(),
            1_786_300_000_000,
        )),
