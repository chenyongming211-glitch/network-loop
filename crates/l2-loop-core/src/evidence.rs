...
pub const EVIDENCE_MAX_CLOSED_AGE_MS: u64 = 30 * 24 * 60 * 60 * 1_000;
pub const EVIDENCE_MIN_FREE_RESERVE_BYTES: u64 = 536_870_912;
pub const EVIDENCE_MIN_FREE_RESERVE_PERCENT: u8 = 5;
