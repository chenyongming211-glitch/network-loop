...
impl InstallRoleV1 {
    pub const fn fixed_destination(self) -> &'static str {
        match self {
            ...
            Self::Installer => "/usr/libexec/l2-loop/l2-loop-install",
    ...
    pub const fn install_order(self) -> u8 {
        match self {
            ...
            Self::HostChecker => 24,
            Self::EbpfObject => 25,
            Self::BundleManifest => 26,
            Self::BundleChecksums => 27,
            Self::ServiceUnit => 28,
            Self::AuthorizationExample => 29,
            Self::DeploymentAuthorization => 30,
            Self::PerformanceEvidence => 31,
        }
    }
